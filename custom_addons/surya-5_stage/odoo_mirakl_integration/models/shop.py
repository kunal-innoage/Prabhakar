...
class ShopIntegrator(models.Model):
    ...
    def setup_offers(self, call):
        ...
        _logger.info("~~~~~awawdawdd~~~~~%r~~~~%r~~~~", response.status_code, response.text)
        if response != False:
            ...
            if order_id:
                ...
                if not processed:
                    ...
                    data = {
                        ...
                        "mobile_no": order.partner_id.mobile,
                        "phone_no": order.partner_id.phone,
                        "order_id": order_id,
