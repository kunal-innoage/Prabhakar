...
class ShopIntegrator(models.Model):
    ...
    def force_validate_shops(self, data):
        ...
        try:
            ...
            response = requests.request("PUT" ,call , headers={'Authorization': self.api_key,'Content-Type': 'application/json'}, data = json.dumps(data)).json()
        ...
        # url = "https://maisonsdumonde-prod.mirakl.net/api/shipments/ship"
